...
const OverviewAnalysisComponent = () => {
  return (
    <Card className='bg-white rounded-t-none rounded-b-md shadow-none border-none mb-4'>
      <CardHeader className='bg-transparent border-none shadow-none'>
      ...
      <CardContent className='p-8'>
        <ChartContainer
          ...
          className='shadow-lg pt-8 pb-4 pr-2  rounded-md max-h-[700px] w-full'>
