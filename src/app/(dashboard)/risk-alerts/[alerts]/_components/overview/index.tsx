    ...
    <div>
      <div className='mb-6 grid gap-4 lg:mb-12 lg:grid-cols-3'>
        ...
        <OverviewCard
          ...
          subHeader={data?.impactedSuppliers?.length || 0}
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-3'>
        <div className='lg:col-span-2 lg:pr-5'>
          ...
          <p className='mb-4 text-xl font-normal'>{data?.summary?.bodyText}</p>
          ...
          <Button
            variant={'outline'}
            onClick={() => router.push(`${data?.summary?.url}`)}
            className='mb-8'>
            Read Full Article
          </Button>
          ...
          <p className='mb-6 text-base font-normal'>{data?.bestPractice}</p>

          <p className='mb-0.5 text-xs font-semibold text-gray-500'>
            Justification
          </p>
          <p className='text-base font-normal'>{data?.justification}</p>
        </div>
