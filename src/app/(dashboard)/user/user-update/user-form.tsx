...
export default function UserFormUpdate({user}:any) {
  ...
  return (
    ...
    <div className='rounded-md p-4 px-6 py-12 lg:px-12 xl:px-32'> 
      <h1 className='mb-4 text-[30px] font-bold'>{userData?.user_metadata?.firstName || ''}{' '}
      {userData?.user_metadata?.lastName || ''} </h1>
    ...
    <div className="py-8">
      <Form {...form}>
        <form onSubmit={form.handleSubmit((data) => update(data))} className="flex flex-col gap-6">
          ...
          <FormRootError />
          <Button type="submit" disabled={isPending} className='max-w-[200px]'>
